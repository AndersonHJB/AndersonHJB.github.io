...
![](https://blog.images.bornforthis.cn/docs-images/sha256/58/580c2ba3cf5285335490c1d2fe556d50602403f6c372e4d6390451e76b412dc5.png)

不过这种方法的一个缺点就是如果前 54 个字符含有块级 HTML 元素标签的话（比如一段代码块），会使摘要比较难看。所以推荐使用第一种方法。

![](https://blog.images.bornforthis.cn/docs-images/sha256/b0/b094565b46ea3c84f46331bad84f3f2b675125f4859dc44f9e6ee43180a518e1.png)
