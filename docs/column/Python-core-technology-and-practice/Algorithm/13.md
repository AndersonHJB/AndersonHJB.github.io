...
![](https://blog.images.bornforthis.cn/docs-images/sha256/fc/fcd2f17ef847e98ce5de90ce0b4cefc5da43fd21d852457726c51848e061c4f4.jpg)
...
![](https://blog.images.bornforthis.cn/docs-images/sha256/71/71574dc2d2e2dcf1f3bb527da0f2ddc1b796e42c2cef1f2bf63a5f3e0e0dd235.png)
...
![](https://blog.images.bornforthis.cn/docs-images/sha256/25/25136f3db3ceae1b273464edb74de3838d282ffd8315a4b204864f5ea5011aa7.png)

如下图所示，重复上述步骤，当未排序数组中只剩下一个元素时，把它添加到已排序的数组末尾，整个数组的排序就完成了。

![](https://blog.images.bornforthis.cn/docs-images/sha256/50/50544d9b1e84a09f6cf24e873d2a79dadc754ab79121f5ba9d0c0ef5cbe5b77f.png)
...
![](https://blog.images.bornforthis.cn/docs-images/sha256/92/92af7fa1c0f12b634974949f7531845e8a3e46852aed7c5e9979dd592401ccb9.png)

此时，它是我们找到的第一个最小数。如下图所示，我们把它与数组的第一个元素交换。

![](https://blog.images.bornforthis.cn/docs-images/sha256/b1/b1231c66d3738222e2bbf07488d8477e0daa590c34d1f7d9bae45fe67a3c6c26.png)



如下图所示，这时候，数组中的第一个位置就成为了有序数据的一部分。

![](https://blog.images.bornforthis.cn/docs-images/sha256/99/99b84927500a701f15b1c93d4a211098627b0182294a4488c774e31541225203.png)

接下来，如下图所示，由于第一个元素已经有序了，所以我们只需要在它之后的数组中搜索最小值。这一趟搜索过后，最小值是 2，所以把 2 和第二个元素交换位置。

![](https://blog.images.bornforthis.cn/docs-images/sha256/35/357175cde0fe70763dd2f13736bdef9dafbb47bb80b147ac1fc245e92599f334.png)

如下图所示，2 和第二个元素交换位置后，第二个位置就成为了这个有序数组的一部分。

![](https://blog.images.bornforthis.cn/docs-images/sha256/de/de5682ad61aa669c42f4849a13834bbc2703daa29da166ca79d916cd96935ef7.png)



接下来，如下图所示，继续重复以上步骤，直到所有元素都被加入到有序数组中。下面给出了确定第三小的数的过程。

![](https://blog.images.bornforthis.cn/docs-images/sha256/e1/e1fdeafec6c6eb316e1270ad1f1e5a76e0ab85a8c10252f4af4e80009ac3652c.png)

如下图，当所有元素都加入有序数组后，排序就完成了。

![](https://blog.images.bornforthis.cn/docs-images/sha256/d8/d862bdfa9c86a823fa82206010c65ed71483631f7c5ebc5913bc47fec185c4c1.png)
