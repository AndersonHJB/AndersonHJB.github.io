...
![](https://blog.images.bornforthis.cn/docs-images/sha256/33/33a9397928b8cfca9e4feeba7395e007389f5a54b74c2b6900f98818dffa69a9.jpg)
...
![](https://blog.images.bornforthis.cn/docs-images/sha256/63/631258b39d96d2998b07f4ebc574778c162ae3b3732ededb184d19e938ca88f5.png)

这时候，如下图所示，我们需交换这两个元素的值。

![](https://blog.images.bornforthis.cn/docs-images/sha256/45/45c668bf53473f12e67df716ee5fb24354540f880f45c1160d06d4d1f1f40bea.png)

接下来遍历到的是第二个元素。如下图所示，此时第二个元素的值已经变为 5。把它和它后方的元素 6 对比，发现 5 和 6 的排列顺序已经是正确的（前面的数小于后面的数），这时候不用进行元素交换，直接继续遍历。

![](https://blog.images.bornforthis.cn/docs-images/sha256/79/796fc47d997024e2dd94f3dbc2d15e42c04f15963f6c943e9ed543e89e353f01.png)

如下图所示，遍历到第三个元素时，发现它比后面的元素更大，这时候就继续交换这两个元素的值。

![](https://blog.images.bornforthis.cn/docs-images/sha256/29/2911b399b94a69f9b7dd0da94b2bb9a269dae21cadd237aa6180fc18d4d705c2.png)

如图所示，在类似的一系列操作后，数组中的最大值被交换到了数组中的最后一个（第8个）位置上。

![](https://blog.images.bornforthis.cn/docs-images/sha256/66/6698119a161cc77c721d42e18017d7485b3c351d80feea6ea9bf25a764b2efe2.png)

如图所示，这时候，我们可以确定末尾元素的值是正确的，所以接下来我们只需要对第1-7个位置上的元素再进行遍历了。

![](https://blog.images.bornforthis.cn/docs-images/sha256/d5/d59949758591b79dd113a1dae557073e064d89abc7eac22a2d5b31735103dcec.png)

在对第 1-7 个位置上的的元素进行遍历之后，我们可以确定排在第 7 位的数。同理，在对第 1-6 个位置上的元素，第 1-5 个位置上的元素等进行遍历后，我们可以确定数组中排在第6位，第 5 位的数等。冒泡排序的剩下过程如图所示。

![](https://blog.images.bornforthis.cn/docs-images/sha256/2a/2a6fae345b11526e77fb5ae70d2f3ccad686c78c0bcfbbd76d4a9e3616efebed.png)
