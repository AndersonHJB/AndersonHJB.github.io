...
![实体关系图（ERD）](https://blog.images.bornforthis.cn/docs-images/sha256/b3/b35a82d6c847d29acc5bcf89076964b22dad12b3419bbfb725993f0d38b1ced5.png)
...
![实体关系图表达了对象间的关系](https://blog.images.bornforthis.cn/docs-images/sha256/de/de6dbc99afd8642b2b8e1d0d39408f2d546d06ea16ad5f1f1301bfe8802f8cf5.png)
...
![实体(实体关系图)](https://blog.images.bornforthis.cn/docs-images/sha256/88/88e8aebf89e65d11aa18b847face65190342910f54fe20c99448348d31ee2b3e.png)
...
![实体属性(实体关系图)](https://blog.images.bornforthis.cn/docs-images/sha256/59/597b68b28cec6d68610c7c6c9b9669263019a724eb5cc5d1f081a209bf885481.png)
...
![主键(实体关系图)](https://blog.images.bornforthis.cn/docs-images/sha256/6e/6e92fe2476c3e02424cd12a6a6474bac802a05c694415eec4bc458b9221fb1f9.png)

#### 外键 (Foreign Key)

外键又称外来键和外部键，是**对主键的引用**，用于识别实体之间的关系。请注意，有别于主键，外键不必是唯一的，多个记录可以共享相同的值。下面的 ER Diagram 示例显示了一个包含一些列的实体，其中一个外键用于引用另一个实体。

![外键(实体关系图)](https://blog.images.bornforthis.cn/docs-images/sha256/b7/b74cedcd86ce7b3adcd88cb391fccce6d96bd72eb1101eb6121cafe2f698766d.png)
...
![一对一的基数的例子](https://blog.images.bornforthis.cn/docs-images/sha256/6a/6a647839fe15148e8544dea3ad2490f131663f3f725b7b1848487fe2fd964671.png)

##### 一对多的基数的例子

一对多关系是指两个实体 X 和 Y 之间的关系，其中 X 的一个实例可以链接到Y的许多实例，而 Y 的一个实例仅链接到 X 的一个实例。下图显示了一对多关系的一个例子。

![一对多的基数的例子](https://blog.images.bornforthis.cn/docs-images/sha256/42/42e6d6d65a8caaa05948785b01d1d3314773c61a7084c64f216c1ff8dbc59304.png)
...
![多对多的基数的例子](https://blog.images.bornforthis.cn/docs-images/sha256/32/32e7a6e8ede4c7a212ec63fc4ee35bd353f27535144075ef222d6534559d7995.png)
...
![概念数据模型](https://blog.images.bornforthis.cn/docs-images/sha256/62/6220717df7d7c4df695bbdaee950ae7f0993dc87fd43a2decb8aa967c4b2695b.png)
...
![逻辑数据模型](https://blog.images.bornforthis.cn/docs-images/sha256/55/551b9d9fea9e8645d8bc14e1438312cbd39e425a122470f5ee866c7f7c224c7d.png)
...
![物理数据模型](https://blog.images.bornforthis.cn/docs-images/sha256/af/af6b28c121e502b9ca21fe6015106749d734d005e2523d276b7faef099a1b625.png)
...
![ERD 示例 - 电影租赁系统](https://blog.images.bornforthis.cn/docs-images/sha256/2d/2d363ad26b1e6059062f4addda59f514045a7e74be3c444f055c31577537f9c4.png)

### ERD 示例 - 贷款系统

![ERD 示例 - 贷款系统](https://blog.images.bornforthis.cn/docs-images/sha256/07/077ce90193f8bce15ea5234afb4f99f6f178084b92e5e59c322ce64c767e2c51.png)

### ERD 示例 - 在线商店

![ERD 示例 - 在线商店](https://blog.images.bornforthis.cn/docs-images/sha256/17/17250efd63a70bd6c0d1e0c5e880e4417e8be1056938a3ebd1e088cc83d1542d.png)
...
![使用 ERD 和数据流图（DFD）](https://blog.images.bornforthis.cn/docs-images/sha256/2c/2cb12f6966101011e4ca14bdaa15269c99bed667f1320b413912087a3a897d60.png)

由于物理 ER 图提供了实际数据库的蓝图，因此这种 ERD 中的实体与 DFD 中的数据存储一致。您可以 ERD 作为 DFD 的补充，以表达信息的结构；或以 DFD 补充 ERD，以显示系统在运行时如何运用数据。

![ER 图数据储存模型](https://blog.images.bornforthis.cn/docs-images/sha256/dc/dc7ea55fabfc8bc3b4718df93e2f6dad1bba9ba461ba16f0fac10a9bf979ba09.png)
...
![使用 ERD 和 BPMN 业务流程图（BPD](https://blog.images.bornforthis.cn/docs-images/sha256/24/24d7464dfc09b5b8946e95b03c8ad8181bac98c7ace32aba399c7c0187c619ad.png)
...
![BPMN 数据对象(以 ER 图表达)](https://blog.images.bornforthis.cn/docs-images/sha256/a0/a07675943c6c7162a9e9933449da1b517eea18491c37ff605eb6aefdc0f34b4a.png)
...
![支持广泛的 DBMS](https://blog.images.bornforthis.cn/docs-images/sha256/be/be7c8be913ac4879283d5a08307fab4d3ccb2f2cd6275736320bfc57cfb2350c.png)
